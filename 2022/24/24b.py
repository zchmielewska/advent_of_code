...
def solve(empty_board, blizzards, expeditions, destination):
...
max_x = empty_board.shape[0] - 1
max_y = empty_board.shape[1] - 1
rund1, blizzards = solve(empty_board, blizzards, expeditions=[(0, 1)], destination="goal")
print(rund1)
rund2, blizzards = solve(empty_board, blizzards, expeditions=[(max_x, max_y-1)], destination="back")
print(rund2)
rund3, blizzards = solve(empty_board, blizzards, expeditions=[(0, 1)], destination="goal")
print(rund3)

print("result", rund1+rund2+rund3)